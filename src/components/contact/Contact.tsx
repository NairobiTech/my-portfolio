          ...
          <div className="contact__content">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <a
                  href="mailto:cetricka@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">254115685790</span>
                  <a
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">Cetrick Afundi</span>
                  <a
                    href="https://m.me/cetrick.afundi/"
                    className="contact__button"
                    target="_blank"
                    rel="noreferrer"
                  >
